                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('format_penomoran', '{nomor_urut}/{kode_surat}/{kode_unit}/{bulan_romawi}/{tahun}') }}"
                               required>
                        <div class="form-text">
                            Placeholder nomor: <code>{nomor_urut}</code> <code>{kode_surat}</code>
