    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                {{-- ── Profile Dropdown (hanya muncul kalau login) ── --}}
                <div class="ms-auto">
                    @auth
                    <div class="dropdown">
                        <div class="profile-pill dropdown-toggle" role="button"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg mt-3" style="border-radius: 15px; min-width: 200px;">
                            ...
                            <li>
                                <a class="dropdown-item rounded-3 py-2 mx-2 w-auto" href="{{ route('profile') }}">
