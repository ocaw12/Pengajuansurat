...
@section('content')
    ...
    <div class="page-verifikasi-wrapper">
        <div class="page-verifikasi-header">
            <div class="page-verifikasi-icon">
                ✓
            </div>
            <div>
        ...
        <div class="verifikasi-grid">
            ...
            <div class="card-verifikasi">
                <div class="card-verifikasi-header">
                    ...
                    <span class="card-verifikasi-pill">
                        Pengajuan
                    </span>
                </div>
                ...
                <div class="detail-row">
                    <div class="detail-label">ID Pengajuan Surat</div>
                    <div class="detail-separator">:</div>
                    <div class="detail-value">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-separator">:</div>
                    <div class="detail-value">
                        {{ $pengajuanSurat->tanggal_pengajuan->format('d-m-Y') }}
                    </div>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-separator">:</div>
                    <div class="detail-value">
                        {{-- Badge status (warna disesuaikan via CSS saja) --}}
            ...
            <div class="card-verifikasi">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-separator">:</div>
                    <div class="detail-value">
                        {{ $approval->tanggal_approval->format('d-m-Y H:i:s') }}
                    </div>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-separator">:</div>
                    <div class="detail-value">
                        @if ($approval->catatan_pejabat)
                            {{ $approval->catatan_pejabat }}
                        @else
                            <span class="detail-muted">Tidak ada catatan tambahan.</span>
                        @endif
                    </div>
                </div>
            </div>
